    ...
    if(!alreadyRecievedBlock)
    {
        if(peersList[(e.currPeer)].node_type == 1)
        {
            ...
            if(lead == 2)
            {
                ...
                {
                    if(i == peersList[(e.currPeer)].private_blocks.size()-1)
                    {
                        break;
                    }
                ...
                auto last_block = peersList[(e.currPeer)].private_blocks[peersList[(e.currPeer)].private_blocks.size()-1];
                peersList[(e.currPeer)].private_blocks.clear();
                peersList[(e.currPeer)].private_blocks.push_back(last_block);
                lead--;
            }
            else if(lead == 1)
            {
